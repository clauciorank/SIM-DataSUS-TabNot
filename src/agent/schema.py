...
PLAN_SYSTEM = (
    ...
    "- Dê preferencia para os valores do contexto de lugar (uf estado e município) se não houver ou não fizer sentido, use os valores da base de conhecimento (oficial do ibge)."
